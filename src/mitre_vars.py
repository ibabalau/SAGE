...
mitre_techniques = {
    ...
    'T1001.001': 'Command and Control.Junk Data',
    'T1001.002': 'Command and Control.Steganography',
    'T1001.003': 'Command and Control.Protocol Impersonation',
    ...
    'T1004': 'Persistence.Winlogon Helper DLL',
    ...
    'T1011.001': 'Exfiltration.Exfiltration Over Bluetooth',
    'T1012': 'Discovery.Query Registry',
    'T1013': 'Privilege Escalation.Port Monitors',
    'T1014': 'Defense Evasion.Rootkit',
    'T1015': 'Privilege Escalation.Accessibility Features',
    ...
    'T1019': 'Persistence.System Firmware',
    'T1020': 'Exfiltration.Automated Exfiltration',
    'T1020.001': 'Exfiltration.Traffic Duplication',
    ...
    'T1027.008': 'Defense Evasion.Stripped Payloads',
    'T1027.009': 'Defense Evasion.Embedded Payloads',
    'T1027.010': 'Defense Evasion.Command Obfuscation',
    'T1027.011': 'Defense Evasion.Fileless Storage',
    'T1028': 'Lateral Movement.Windows Remote Management',
    ...
    'T1034': 'Privilege Escalation.Path Interception',
    ...
    'T1036.008': 'Defense Evasion.Masquerade File Type',
    'T1037': 'Privilege Escalation.Boot or Logon Initialization Scripts',
    'T1037.001': 'Privilege Escalation.Logon Script (Windows)',
    'T1037.002': 'Privilege Escalation.Login Hook',
    'T1037.003': 'Privilege Escalation.Network Logon Script',
    'T1037.004': 'Privilege Escalation.RC Scripts',
    'T1037.005': 'Privilege Escalation.Startup Items',
    ...
    'T1042': 'Persistence.Change Default File Association',
    'T1043': 'Command and Control.Commonly Used Port',
    'T1044': 'Privilege Escalation.File System Permissions Weakness',
    ...
    'T1050': 'Privilege Escalation.New Service',
    'T1051': 'Lateral Movement.Shared Webroot',
    ...
    'T1053.001': 'Privilege Escalation.At (Linux)',
    'T1053.002': 'Privilege Escalation.At',
    'T1053.003': 'Privilege Escalation.Cron',
    'T1053.004': 'Privilege Escalation.Launchd',
    'T1053.005': 'Privilege Escalation.Scheduled Task',
    'T1053.006': 'Privilege Escalation.Systemd Timers',
    'T1053.007': 'Privilege Escalation.Container Orchestration Job',
    'T1054': 'Defense Evasion.Indicator Blocking',
    ...
    'T1055.005': 'Privilege Escalation.Thread Local Storage',
    'T1055.008': 'Privilege Escalation.Ptrace System Calls',
    'T1055.009': 'Privilege Escalation.Proc Memory',
    'T1055.011': 'Privilege Escalation.Extra Window Memory Injection',
    'T1055.012': 'Privilege Escalation.Process Hollowing',
    'T1055.013': 'Privilege Escalation.Process Doppelgänging',
    'T1055.014': 'Privilege Escalation.VDSO Hijacking',
    'T1055.015': 'Privilege Escalation.ListPlanting',
    ...
    'T1056.004': 'Credential Access.Credential API Hooking',
    'T1057': 'Discovery.Process Discovery',
    'T1058': 'Privilege Escalation.Service Registry Permissions Weakness',
    ...
    'T1061': 'Execution.Graphical User Interface',
    'T1062': 'Persistence.Hypervisor',
    ...
    'T1070.005': 'Defense Evasion.Network Share Connection Removal',
    'T1070.006': 'Defense Evasion.Timestomp',
    'T1070.007': 'Defense Evasion.Clear Network Connection History and Configurations',
    'T1070.008': 'Defense Evasion.Clear Mailbox Data',
    'T1070.009': 'Defense Evasion.Clear Persistence',
    ...
    'T1073': 'Defense Evasion.DLL Side-Loading',
    ...
    'T1076': 'Lateral Movement.Remote Desktop Protocol',
    'T1077': 'Lateral Movement.Windows Admin Shares',
    'T1078': 'Initial Access.Valid Accounts',
    'T1078.001': 'Initial Access.Default Accounts',
    'T1078.002': 'Initial Access.Domain Accounts',
    'T1078.003': 'Initial Access.Local Accounts',
    'T1078.004': 'Initial Access.Cloud Accounts',
    'T1079': 'Command and Control.Multilayer Encryption',
    ...
    'T1088': 'Privilege Escalation.Bypass User Account Control',
    ...
    'T1097': 'Lateral Movement.Pass the Ticket',
    ...
    'T1100': 'Privilege Escalation.Web Shell',
    'T1101': 'Persistence.Security Support Provider',
    ...
    'T1102.003': 'Command and Control.One-Way Communication',
    'T1103': 'Privilege Escalation.AppInit DLLs',
    ...
    'T1109': 'Persistence.Component Firmware',
    ...
    'T1137.002': 'Persistence.Office Test',
    'T1137.003': 'Persistence.Outlook Forms',
    'T1137.004': 'Persistence.Outlook Home Page',
    'T1137.005': 'Persistence.Outlook Rules',
    'T1137.006': 'Persistence.Add-ins',
    'T1138': 'Privilege Escalation.Application Shimming',
    'T1139': 'Credential Access.Bash History',
    'T1140': 'Defense Evasion.Deobfuscate/Decode Files or Information',
    'T1141': 'Credential Access.Input Prompt',
    'T1142': 'Credential Access.Keychain',
    'T1143': 'Defense Evasion.Hidden Window',
    'T1144': 'Defense Evasion.Gatekeeper Bypass',
    'T1145': 'Credential Access.Private Keys',
    'T1146': 'Defense Evasion.Clear Command History',
    'T1147': 'Defense Evasion.Hidden Users',
    'T1148': 'Defense Evasion.HISTCONTROL',
    'T1149': 'Defense Evasion.LC_MAIN Hijacking',
    'T1150': 'Privilege Escalation.Plist Modification',
    'T1151': 'Execution.Space after Filename',
    'T1152': 'Persistence.Launchctl',
    'T1153': 'Execution.Source',
    'T1154': 'Persistence.Trap',
    'T1155': 'Execution.AppleScript',
    'T1156': 'Persistence.Malicious Shell Modification',
    'T1157': 'Privilege Escalation.Dylib Hijacking',
    'T1158': 'Persistence.Hidden Files and Directories',
    'T1159': 'Persistence.Launch Agent',
    'T1160': 'Privilege Escalation.Launch Daemon',
    'T1161': 'Persistence.LC_LOAD_DYLIB Addition',
    'T1162': 'Persistence.Login Item',
    'T1163': 'Persistence.Rc.common',
    'T1164': 'Persistence.Re-opened Applications',
    'T1165': 'Privilege Escalation.Startup Items',
    'T1166': 'Persistence.Setuid and Setgid',
    'T1167': 'Credential Access.Securityd Memory',
    'T1168': 'Execution.Local Job Scheduling',
    'T1169': 'Privilege Escalation.Sudo',
    'T1170': 'Execution.Mshta',
    'T1171': 'Credential Access.LLMNR/NBT-NS Poisoning and Relay',
    'T1172': 'Command and Control.Domain Fronting',
    'T1173': 'Execution.Dynamic Data Exchange',
    'T1174': 'Credential Access.Password Filter DLL',
    'T1175': 'Execution.Component Object Model and Distributed COM',
    'T1176': 'Persistence.Browser Extensions',
    'T1177': 'Persistence.LSASS Driver',
    'T1178': 'Privilege Escalation.SID-History Injection',
    'T1179': 'Credential Access.Hooking',
    'T1180': 'Persistence.Screensaver',
    'T1181': 'Privilege Escalation.Extra Window Memory Injection',
    'T1182': 'Privilege Escalation.AppCert DLLs',
    'T1183': 'Defense Evasion.Image File Execution Options Injection',
    'T1184': 'Lateral Movement.SSH Hijacking',
    'T1185': 'Collection.Browser Session Hijacking',
    'T1186': 'Defense Evasion.Process Doppelgänging',
    'T1187': 'Credential Access.Forced Authentication',
    'T1188': 'Command and Control.Multi-hop Proxy',
    'T1189': 'Initial Access.Drive-by Compromise',
    'T1190': 'Initial Access.Exploit Public-Facing Application',
    'T1191': 'Execution.CMSTP',
    ...
    'T1196': 'Execution.Control Panel Items',
    'T1197': 'Persistence.BITS Jobs',
    'T1198': 'Persistence.SIP and Trust Provider Hijacking',
    ...
    'T1205': 'Command and Control.Traffic Signaling',
    'T1205.001': 'Command and Control.Port Knocking',
    'T1205.002': 'Command and Control.Socket Filters',
    'T1206': 'Privilege Escalation.Sudo Caching',
    'T1207': 'Defense Evasion.Rogue Domain Controller',
    'T1208': 'Credential Access.Kerberoasting',
    'T1209': 'Persistence.Time Providers',
    ...
    'T1218.002': 'Defense Evasion.Control Panel',
    ...
    'T1218.012': 'Defense Evasion.Verclsid',
    'T1218.013': 'Defense Evasion.Mavinject',
    'T1218.014': 'Defense Evasion.MMC',
    ...
    'T1222.001': 'Defense Evasion.Windows File and Directory Permissions Modification',
    'T1222.002': 'Defense Evasion.Linux and Mac File and Directory Permissions Modification',
    'T1223': 'Execution.Compiled HTML File',
    'T1480': 'Defense Evasion.Execution Guardrails',
    'T1480.001': 'Defense Evasion.Environmental Keying',
    'T1482': 'Discovery.Domain Trust Discovery',
    'T1483': 'Command and Control.Domain Generation Algorithms',
    'T1484': 'Privilege Escalation.Domain Policy Modification',
    'T1484.001': 'Privilege Escalation.Group Policy Modification',
    'T1484.002': 'Privilege Escalation.Domain Trust Modification',
    'T1485': 'Impact.Data Destruction',
    'T1486': 'Impact.Data Encrypted for Impact',
    'T1487': 'Impact.Disk Structure Wipe',
    'T1488': 'Impact.Disk Content Wipe',
    'T1489': 'Impact.Service Stop',
    'T1490': 'Impact.Inhibit System Recovery',
    'T1491': 'Impact.Defacement',
    'T1491.001': 'Impact.Internal Defacement',
    'T1491.002': 'Impact.External Defacement',
    'T1492': 'Impact.Stored Data Manipulation',
    'T1493': 'Impact.Transmitted Data Manipulation',
    'T1494': 'Impact.Runtime Data Manipulation',
    'T1495': 'Impact.Firmware Corruption',
    'T1496': 'Impact.Resource Hijacking',
    'T1497': 'Discovery.Virtualization/Sandbox Evasion',
    'T1497.001': 'Discovery.System Checks',
    'T1497.002': 'Discovery.User Activity Based Checks',
    'T1497.003': 'Discovery.Time Based Evasion',
    ...
    'T1500': 'Defense Evasion.Compile After Delivery',
    'T1501': 'Persistence.Systemd Service',
    'T1502': 'Privilege Escalation.Parent PID Spoofing',
    'T1503': 'Credential Access.Credentials from Web Browsers',
    'T1504': 'Privilege Escalation.PowerShell Profile',
    'T1505': 'Persistence.Server Software Component',
    'T1505.001': 'Persistence.SQL Stored Procedures',
    'T1505.002': 'Persistence.Transport Agent',
    'T1505.003': 'Persistence.Web Shell',
    'T1505.004': 'Persistence.IIS Components',
    'T1505.005': 'Persistence.Terminal Services DLL',
    'T1506': 'Lateral Movement.Web Session Cookie',
    ...
    'T1519': 'Privilege Escalation.Emond',
    'T1522': 'Credential Access.Cloud Instance Metadata API',
    'T1525': 'Persistence.Implant Internal Image',
    'T1526': 'Discovery.Cloud Service Discovery',
    'T1527': 'Lateral Movement.Application Access Token',
    ...
    'T1536': 'Defense Evasion.Revert Cloud Instance',
    ...
    'T1542.001': 'Defense Evasion.System Firmware',
    'T1542.002': 'Defense Evasion.Component Firmware',
    'T1542.003': 'Defense Evasion.Bootkit',
    'T1542.004': 'Persistence.ROMMONkit',
    'T1542.005': 'Persistence.TFTP Boot',
    'T1543': 'Privilege Escalation.Create or Modify System Process',
    'T1543.001': 'Privilege Escalation.Launch Agent',
    'T1543.002': 'Privilege Escalation.Systemd Service',
    'T1543.003': 'Privilege Escalation.Windows Service',
    'T1543.004': 'Privilege Escalation.Launch Daemon',
    'T1546': 'Persistence.Event Triggered Execution',
    'T1546.001': 'Persistence.Change Default File Association',
    'T1546.002': 'Persistence.Screensaver',
    'T1546.003': 'Persistence.Windows Management Instrumentation Event Subscription',
    'T1546.004': 'Persistence.Unix Shell Configuration Modification',
    'T1546.005': 'Persistence.Trap',
    'T1546.006': 'Persistence.LC_LOAD_DYLIB Addition',
    'T1546.007': 'Persistence.Netsh Helper DLL',
    'T1546.008': 'Persistence.Accessibility Features',
    'T1546.009': 'Persistence.AppCert DLLs',
    ...
    'T1546.013': 'Persistence.PowerShell Profile',
    'T1546.014': 'Persistence.Emond',
    'T1546.015': 'Persistence.Component Object Model Hijacking',
    'T1546.016': 'Persistence.Installer Packages',
    ...
    'T1547.002': 'Privilege Escalation.Authentication Package',
    'T1547.003': 'Privilege Escalation.Time Providers',
    'T1547.004': 'Privilege Escalation.Winlogon Helper DLL',
    'T1547.005': 'Privilege Escalation.Security Support Provider',
    'T1547.006': 'Privilege Escalation.Kernel Modules and Extensions',
    'T1547.007': 'Privilege Escalation.Re-opened Applications',
    'T1547.008': 'Privilege Escalation.LSASS Driver',
    'T1547.009': 'Privilege Escalation.Shortcut Modification',
    'T1547.010': 'Privilege Escalation.Port Monitors',
    'T1547.011': 'Privilege Escalation.Plist Modification',
    'T1547.012': 'Privilege Escalation.Print Processors',
    'T1547.013': 'Privilege Escalation.XDG Autostart Entries',
    'T1547.014': 'Privilege Escalation.Active Setup',
    'T1547.015': 'Privilege Escalation.Login Items',
    'T1548': 'Defense Evasion.Abuse Elevation Control Mechanism',
    'T1548.001': 'Defense Evasion.Setuid and Setgid',
    'T1548.002': 'Defense Evasion.Bypass User Account Control',
    'T1548.003': 'Defense Evasion.Sudo and Sudo Caching',
    'T1548.004': 'Defense Evasion.Elevated Execution with Prompt',
    ...
    'T1552.003': 'Credential Access.Bash History',
    'T1552.004': 'Credential Access.Private Keys',
    'T1552.005': 'Credential Access.Cloud Instance Metadata API',
    'T1552.006': 'Credential Access.Group Policy Preferences',
    'T1552.007': 'Credential Access.Container API',
    'T1552.008': 'Credential Access.Chat Messages',
    'T1553': 'Defense Evasion.Subvert Trust Controls',
    'T1553.001': 'Defense Evasion.Gatekeeper Bypass',
    'T1553.002': 'Defense Evasion.Code Signing',
    'T1553.003': 'Defense Evasion.SIP and Trust Provider Hijacking',
    'T1553.004': 'Defense Evasion.Install Root Certificate',
    'T1553.005': 'Defense Evasion.Mark-of-the-Web Bypass',
    ...
    'T1555.002': 'Credential Access.Securityd Memory',
    ...
    'T1556.001': 'Persistence.Domain Controller Authentication',
    'T1556.002': 'Persistence.Password Filter DLL',
    'T1556.003': 'Persistence.Pluggable Authentication Modules',
    'T1556.004': 'Persistence.Network Device Authentication',
    'T1556.005': 'Persistence.Reversible Encryption',
    'T1556.006': 'Persistence.Multi-Factor Authentication',
    'T1556.007': 'Persistence.Hybrid Identity',
    'T1556.008': 'Persistence.Network Provider DLL',
    'T1557': 'Collection.Adversary-in-the-Middle',
    'T1557.001': 'Collection.LLMNR/NBT-NS Poisoning and SMB Relay',
    'T1557.002': 'Collection.ARP Cache Poisoning',
    'T1557.003': 'Collection.DHCP Spoofing',
    ...
    'T1559.003': 'Execution.XPC Services',
    'T1560': 'Collection.Archive Collected Data',
    'T1560.001': 'Collection.Archive via Utility',
    'T1560.002': 'Collection.Archive via Library',
    'T1560.003': 'Collection.Archive via Custom Method',
    ...
    'T1562.007': 'Defense Evasion.Disable or Modify Cloud Firewall',
    'T1562.008': 'Defense Evasion.Disable Cloud Logs',
    'T1562.009': 'Defense Evasion.Safe Mode Boot',
    'T1562.010': 'Defense Evasion.Downgrade Attack',
    'T1562.011': 'Defense Evasion.Spoof Security Alerting',
    ...
    'T1564.005': 'Defense Evasion.Hidden File System',
    'T1564.006': 'Defense Evasion.Run Virtual Instance',
    'T1564.007': 'Defense Evasion.VBA Stomping',
    'T1564.008': 'Defense Evasion.Email Hiding Rules',
    'T1564.009': 'Defense Evasion.Resource Forking',
    'T1564.010': 'Defense Evasion.Process Argument Spoofing',
    'T1565': 'Impact.Data Manipulation',
    'T1565.001': 'Impact.Stored Data Manipulation',
    'T1565.002': 'Impact.Transmitted Data Manipulation',
    'T1565.003': 'Impact.Runtime Data Manipulation',
    ...
    'T1568.003': 'Command and Control.DNS Calculation',
    ...
    'T1574': 'Defense Evasion.Hijack Execution Flow',
    'T1574.001': 'Defense Evasion.DLL Search Order Hijacking',
    'T1574.002': 'Defense Evasion.DLL Side-Loading',
    'T1574.004': 'Defense Evasion.Dylib Hijacking',
    'T1574.005': 'Defense Evasion.Executable Installer File Permissions Weakness',
    'T1574.006': 'Defense Evasion.Dynamic Linker Hijacking',
    'T1574.007': 'Defense Evasion.Path Interception by PATH Environment Variable',
    'T1574.008': 'Defense Evasion.Path Interception by Search Order Hijacking',
    'T1574.009': 'Defense Evasion.Path Interception by Unquoted Path',
    'T1574.010': 'Defense Evasion.Services File Permissions Weakness',
    'T1574.011': 'Defense Evasion.Services Registry Permissions Weakness',
    'T1574.012': 'Defense Evasion.COR_PROFILER',
    'T1574.013': 'Defense Evasion.KernelCallbackTable',
    'T1578': 'Defense Evasion.Modify Cloud Compute Infrastructure',
    'T1578.001': 'Defense Evasion.Create Snapshot',
    'T1578.002': 'Defense Evasion.Create Cloud Instance',
    'T1578.003': 'Defense Evasion.Delete Cloud Instance',
    'T1578.004': 'Defense Evasion.Revert Cloud Instance',
    ...
    'T1583.002': 'Resource Development.DNS Server',
    'T1583.003': 'Resource Development.Virtual Private Server',
    'T1583.004': 'Resource Development.Server',
    'T1583.005': 'Resource Development.Botnet',
    'T1583.006': 'Resource Development.Web Services',
    'T1583.007': 'Resource Development.Serverless',
    'T1583.008': 'Resource Development.Malvertising',
    'T1584': 'Resource Development.Compromise Infrastructure',
    'T1584.001': 'Resource Development.Domains',
    'T1584.002': 'Resource Development.DNS Server',
    'T1584.003': 'Resource Development.Virtual Private Server',
    'T1584.004': 'Resource Development.Server',
    'T1584.005': 'Resource Development.Botnet',
    'T1584.006': 'Resource Development.Web Services',
    'T1584.007': 'Resource Development.Serverless',
    ...
    'T1585.003': 'Resource Development.Cloud Accounts',
    ...
    'T1586.003': 'Resource Development.Cloud Accounts',
    ...
    'T1588.003': 'Resource Development.Code Signing Certificates',
    ...
    'T1590.003': 'Reconnaissance.Network Trust Dependencies',
    ...
    'T1591.003': 'Reconnaissance.Identify Business Tempo',
    ...
    'T1592.003': 'Reconnaissance.Firmware',
    ...
    'T1593.003': 'Reconnaissance.Code Repositories',
    ...
    'T1596.003': 'Reconnaissance.Digital Certificates',
    'T1596.004': 'Reconnaissance.CDNs',
    'T1596.005': 'Reconnaissance.Scan Databases',
    'T1597': 'Reconnaissance.Search Closed Sources',
    'T1597.001': 'Reconnaissance.Threat Intel Vendors',
    'T1597.002': 'Reconnaissance.Purchase Technical Data',
    ...
    'T1599.001': 'Defense Evasion.Network Address Translation Traversal',
    'T1600': 'Defense Evasion.Weaken Encryption',
    'T1600.001': 'Defense Evasion.Reduce Key Space',
    'T1600.002': 'Defense Evasion.Disable Crypto Hardware',
    'T1601': 'Defense Evasion.Modify System Image',
    'T1601.001': 'Defense Evasion.Patch System Image',
    'T1601.002': 'Defense Evasion.Downgrade System Image',
    'T1602': 'Collection.Data from Configuration Repository',
    'T1602.001': 'Collection.SNMP (MIB Dump)',
    'T1602.002': 'Collection.Network Device Configuration Dump',
    'T1606': 'Credential Access.Forge Web Credentials',
    'T1606.001': 'Credential Access.Web Cookies',
    'T1606.002': 'Credential Access.SAML Tokens',
    'T1608': 'Resource Development.Stage Capabilities',
    'T1608.001': 'Resource Development.Upload Malware',
    'T1608.002': 'Resource Development.Upload Tool',
    'T1608.003': 'Resource Development.Install Digital Certificate',
    'T1608.004': 'Resource Development.Drive-by Target',
    'T1608.005': 'Resource Development.Link Target',
    ...
    'T1647': 'Defense Evasion.Plist File Modification',
    'T1648': 'Execution.Serverless Execution',
    'T1649': 'Credential Access.Steal or Forge Authentication Certificates',
    'T1650': 'Resource Development.Acquire Access',
    'T1651': 'Execution.Cloud Administration Command',
    'T1652': 'Discovery.Device Driver Discovery',
    ...
    'Commandand Control': 'Commandand Control',
